...
THREE.MaterialExporter.prototype = {
	...
	parse: function ( material ) {
		...
		if ( material instanceof THREE.MeshBasicMaterial ) {
			...
			output.transparent = material.transparent;
			output.wireframe = material.wireframe;
			output.falloff = material.falloff;
			output.falloffColor = material.falloffColor.getHex();
			output.roughness = material.roughness;
			output.metallic = material.metallic;
			output.clearCoat = material.clearCoat;
			output.clearCoatRoughness = material.clearCoatRoughness;
			output.anisotropy = material.anisotropy;
			output.anisotropyRotation = material.anisotropyRotation;
			output.translucency = material.translucency.getHex();
			output.translucencyNormalAlpha = material.translucencyNormalAlpha;
			output.translucencyNormalPower = material.translucencyNormalPower;
			output.translucencyViewAlpha = material.translucencyViewAlpha;
			output.translucencyViewPower = material.translucencyViewPower;
