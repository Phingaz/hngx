  ...
  return (
    <div className="flex flex-col gap-2">
      <div className="relative w-full">
        <div className="absolute top-0 left-0 w-full min-h-[45px] flex justify-between items-center md:p-5 p-2">
          <p className="bg-white bg-opacity-50 text-gray-900 font-semibold uppercase px-2 py-1 rounded-3xl text-[0.8rem] md:text-base">
            Tv series
          </p>
          <p className="bg-white bg-opacity-50 text-gray-900 p-2 rounded-full w-[30px] h-[30px] md:w-[40px] flex justify-center items-center cursor-pointer">
            <FavoriteIcon className="text-slate-300 w-full h-full" />
          </p>
        </div>
      ...
      <h2 className="text-gray-900 font-semibold md:text-2xl capitalize">
        Stranger things
      </h2>
      ...
      <p className="font-semibold text-base text-gray-400 md:text-base text-sm">
